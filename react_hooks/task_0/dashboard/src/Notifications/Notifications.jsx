...
class Notifications extends PureComponent {
  render() {
    ...
    const displayDrawer = this.props.displayDrawer === true;
    const handleDisplayDrawer = this.props.handleDisplayDrawer ? this.props.handleDisplayDrawer : () => { };
    const handleHideDrawer = this.props.handleHideDrawer ? this.props.handleHideDrawer : () => { };
    const markNotificationAsRead = this.props.markNotificationAsRead ? this.props.markNotificationAsRead : () => { };
